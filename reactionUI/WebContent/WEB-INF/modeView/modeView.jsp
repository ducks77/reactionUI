...
<%
	String url = "http://192.168.0.30:9000/Site/ReaIndex";
%>
...
<div id="mode_view">
    ...
    <div id="frame_wrap" style="width: 100%; height: 874px; margin-top: 0px; margin-bottom: 0px; padding: 0px; overflow: hidden;">
        <div class="mode_bg mode_laptop" style="opacity: 0;"><img src="../modeViewSets/reactionImage/mode_laptop.png"></div>
        <div class="mode_bg mode_tablet" style="opacity: 0;"><img src="../modeViewSets/reactionImage/mode_tablet.png"></div>
        <div class="mode_bg mode_mobile" style="opacity: 0;"><img src="../modeViewSets/reactionImage/mode_mobile.png"></div>
